...
const RegisterForm = ({ user }: { user: User }) => {
  ...
  async function onSubmit({
    ...
    try {
      ...
      //We have to take this 'userData' and pass it somewhere to
      //save it to database.
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="space-y-12 flex-1 text-white"
      >
        ...
        <SubmitButton
          isloading={isloading}
          className="border-2 bg-green-400 text-black w-full"
        >
          Get Started
        </SubmitButton>
      </form>
